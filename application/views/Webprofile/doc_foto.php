          ...
          <div class="col-sm-12">
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('Admin/Dokumentasi/video') ?>">Video</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="<?=base_url('Admin/Dokumentasi/foto') ?>" 
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $data->tgl_dokumentasi_foto; ?></td>
                  <td>
                  <?php 
                  $akt=$data->status;
                  if($akt==1){
                  ...
                  <td>
                  <a class="btn" data-toggle="modal" data-target="#modal-edit<?= $data->id_dokumentasi_foto;?>"><span class="fa fa-pencil"></span></a>
                    <a class="btn" data-toggle="modal" data-target="#modal-info<?= $data->id_dokumentasi_foto;?>"><span class="fa fa-info"></span></a>
                    <a class="btn" data-toggle="modal" data-target="#modal-hapus<?= $data->id_dokumentasi_foto;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                <?php endforeach?>
              </table>
    ...
    reserved.
      ...
      <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?= base_url().'Admin/Dokumentasi/addfoto'?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
        ...
        <?php
          foreach($dokumentasi as $data):         
        ?>
      <div class="modal fade" id="modal-info<?= $data->id_dokumentasi_foto; ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="col-md-4">
                <img src="<?= base_url().'assets/images/'. $data->foto; ?>" style="width:500px;">
            </div>
            <div class="col-md-1">
            </div>
            </div>
      ...
      <?php endforeach?>
       ...
       <?php
          foreach($dokumentasi as $data):         
        ?>
      <div class="modal fade" id="modal-hapus<?= $data->id_dokumentasi_foto; ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url().'Admin/Dokumentasi/hapus_foto'?>" 
            method="post" enctype="multipart/form-data">
            <div class="modal-body">
            <p>Apa Anda yakin akan mengapus foto <b><?= $data->nama_kegiatan;?></b> ?</p>
            <input type="hidden" name="id_dokumentasi_foto" value="<?php echo $data->id_dokumentasi_foto;?>"/>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      ...
      ?>
      <!-- /.modal-Edit -->
      <div class="modal fade" id="modal-edit<?= $data->id_dokumentasi_foto; ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
            <form method="post" action="<?= base_url().'Admin/Dokumentasi/editfoto'?>" enctype="multipart/form-data">
                <div class="card-body">
                  <input type="hidden" name="id_dokumentasi_foto" value="<?php echo $data->id_dokumentasi_foto;?>"/>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Kegiatan</label>
