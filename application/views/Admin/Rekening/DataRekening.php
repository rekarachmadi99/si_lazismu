            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('') ?>beranda/datarekening" class="nav-link active">
                                <i class="nav-icon fa fa-fw fa-shopping-cart"></i>
                                <p>
                                    Data Rekening
                                </p>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                if ($key['foto_rekening'] == null) {
                                                } else {

                                                ?>
                                                    <td>
                                                        <img src="<?= base_url('uploads/rekening/' . $key['foto_rekening']) ?>" style="width:100px">
                                                    </td>
                                                <?php
                                                }
                                                ?>
                                                <td><a href="<?= base_url('') ?>Beranda/edit_rekening?id=<?php echo $key['id_rekening'] ?>" class="btn btn-primary btn-block" role="button">Edit</a><a href="<?= base_url('') ?>QueryLazismu/hapus_rekening?id=<?php echo $key['id_rekening'] ?>" class="btn btn-primary btn-block" role="button">Hapus</a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
