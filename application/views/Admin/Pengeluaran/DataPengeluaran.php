                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $data = "SELECT pengeluaran.id_pengeluaran as id_pengeluaran, pengeluaran.id_pegawai as id_pegawai,pengeluaran.id_rekening as id_rekening, pengeluaran.id_pengeluaran as id_pengeluaran, jenis_pengeluaran.nama_pengeluaran as nama_pengeluaran, pengeluaran.tgl_pengeluaran as tgl_pengeluaran, pengeluaran.jam_pengeluaran as jam_pengeluaran, pengeluaran.nominal as nominal, pengeluaran.ket as ket FROM pengeluaran INNER JOIN jenis_pengeluaran ON pengeluaran.id_jenis_pengeluaran = jenis_pengeluaran.id_pengeluaran ";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('') ?>beranda/edit_pengeluaran?id=<?php echo $key['id_pengeluaran'] ?>" class="btn btn-primary btn-block" role="button">Edit</a><a href="<?= base_url('') ?>QueryLazismu/hapus_pengeluaran?id=<?php echo $key['id_pengeluaran'] ?>" class="btn btn-primary btn-block" role="button">Hapus</a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
