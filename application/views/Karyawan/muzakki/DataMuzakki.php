                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $key['nama_muzakki'] ?></td>
                                                <td><?php echo $key['alamat_muzakki'] ?></td>
                                                <td><?php echo $key['notelp_muzakki'] ?></td>
                                                <td><?php echo $key['npwp'] ?></td>
                                                <td><?php echo $key['npwz'] ?></td>
                                                <td><?php echo $key['nama_golongan'] ?></td>
                                                <td><a href="<?= base_url('') ?>beranda/edit_muzakki?id=<?php echo $key['id_muzakki'] ?>" class="btn btn-primary btn-block" role="button">Edit</a><a href="<?= base_url('') ?>QueryLazismu/hapus_muzakki?id=<?php echo $key['id_muzakki'] ?>" class="btn btn-primary btn-block" role="button">Hapus</a></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
